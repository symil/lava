...
impl VkType<RawVkIndirectCommandsTokenType> for VkIndirectCommandsTokenType {
    
    fn vk_to_raw(src: &VkIndirectCommandsTokenType, dst: &mut RawVkIndirectCommandsTokenType) {
        *dst = *src as i32
    }
    
    fn vk_from_raw(src: &RawVkIndirectCommandsTokenType) -> VkIndirectCommandsTokenType {
        unsafe {
