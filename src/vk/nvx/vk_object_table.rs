...
impl VkObjectTable {
    ...
    pub fn register_objects(&self, object_table_entries: &[&nvx::VkObjectTableEntry], object_indices: &[usize]) -> VkResult {
        unsafe {
    ...
    pub fn unregister_objects(&self, object_entry_types: &[nvx::VkObjectEntryType], object_indices: &[usize]) -> VkResult {
        unsafe {
