...
impl VkType<RawVkDescriptorUpdateTemplateType> for VkDescriptorUpdateTemplateType {
    
    fn vk_to_raw(src: &VkDescriptorUpdateTemplateType, dst: &mut RawVkDescriptorUpdateTemplateType) {
        *dst = *src as i32
    }
    
    fn vk_from_raw(src: &RawVkDescriptorUpdateTemplateType) -> VkDescriptorUpdateTemplateType {
        unsafe {
