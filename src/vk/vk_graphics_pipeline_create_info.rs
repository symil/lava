...
pub struct RawVkGraphicsPipelineCreateInfo {
    ...
    stage_count: u32,
    stages: *mut RawVkPipelineShaderStageCreateInfo,
    vertex_input_state: *mut RawVkPipelineVertexInputStateCreateInfo,
    input_assembly_state: *mut RawVkPipelineInputAssemblyStateCreateInfo,
    tessellation_state: *mut RawVkPipelineTessellationStateCreateInfo,
    viewport_state: *mut RawVkPipelineViewportStateCreateInfo,
    rasterization_state: *mut RawVkPipelineRasterizationStateCreateInfo,
    multisample_state: *mut RawVkPipelineMultisampleStateCreateInfo,
    depth_stencil_state: *mut RawVkPipelineDepthStencilStateCreateInfo,
    color_blend_state: *mut RawVkPipelineColorBlendStateCreateInfo,
    dynamic_state: *mut RawVkPipelineDynamicStateCreateInfo,
