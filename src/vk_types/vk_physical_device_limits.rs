...
impl<'a> From<&'a RawVkPhysicalDeviceLimits> for VkPhysicalDeviceLimits {
    fn from(value: &'a RawVkPhysicalDeviceLimits) -> Self {
        VkPhysicalDeviceLimits {
            max_image_dimension1_d: value.max_image_dimension1_d,
            max_image_dimension2_d: value.max_image_dimension2_d,
            max_image_dimension3_d: value.max_image_dimension3_d,
