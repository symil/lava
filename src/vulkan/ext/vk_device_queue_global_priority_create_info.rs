...
/// Wrapper for [VkDeviceQueueGlobalPriorityCreateInfoEXT](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceQueueGlobalPriorityCreateInfoEXT.html).
#[derive(Debug, Clone)]
