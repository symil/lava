...
/// Wrapper for [VkPipelineCreationFeedbackCreateInfoEXT](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPipelineCreationFeedbackCreateInfoEXT.html).
#[derive(Debug, Clone)]
