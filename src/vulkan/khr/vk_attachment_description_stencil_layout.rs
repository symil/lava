...
/// Wrapper for [VkAttachmentDescriptionStencilLayoutKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkAttachmentDescriptionStencilLayoutKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkAttachmentDescriptionStencilLayout> for VkAttachmentDescriptionStencilLayout {
    fn vk_to_raw(src: &VkAttachmentDescriptionStencilLayout, dst: &mut RawVkAttachmentDescriptionStencilLayout) {
        dst.s_type = vk_to_raw_value(&VkStructureType::AttachmentDescriptionStencilLayoutKhr);
