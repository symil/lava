...
/// Wrapper for [VkBufferDeviceAddressInfoKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkBufferDeviceAddressInfoKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkBufferDeviceAddressInfo> for VkBufferDeviceAddressInfo {
    fn vk_to_raw(src: &VkBufferDeviceAddressInfo, dst: &mut RawVkBufferDeviceAddressInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::BufferDeviceAddressInfoKhr);
