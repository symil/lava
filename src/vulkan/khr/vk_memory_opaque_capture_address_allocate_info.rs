...
/// Wrapper for [VkMemoryOpaqueCaptureAddressAllocateInfoKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkMemoryOpaqueCaptureAddressAllocateInfoKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkMemoryOpaqueCaptureAddressAllocateInfo> for VkMemoryOpaqueCaptureAddressAllocateInfo {
    fn vk_to_raw(src: &VkMemoryOpaqueCaptureAddressAllocateInfo, dst: &mut RawVkMemoryOpaqueCaptureAddressAllocateInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::MemoryOpaqueCaptureAddressAllocateInfoKhr);
