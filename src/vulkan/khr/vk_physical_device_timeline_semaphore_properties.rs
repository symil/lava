...
/// Wrapper for [VkPhysicalDeviceTimelineSemaphorePropertiesKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkPhysicalDeviceTimelineSemaphorePropertiesKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDeviceTimelineSemaphoreProperties> for VkPhysicalDeviceTimelineSemaphoreProperties {
    fn vk_to_raw(src: &VkPhysicalDeviceTimelineSemaphoreProperties, dst: &mut RawVkPhysicalDeviceTimelineSemaphoreProperties) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDeviceTimelineSemaphorePropertiesKhr);
