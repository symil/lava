...
/// Wrapper for [VkRenderPassAttachmentBeginInfoKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkRenderPassAttachmentBeginInfoKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkRenderPassAttachmentBeginInfo> for VkRenderPassAttachmentBeginInfo {
    fn vk_to_raw(src: &VkRenderPassAttachmentBeginInfo, dst: &mut RawVkRenderPassAttachmentBeginInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::RenderPassAttachmentBeginInfoKhr);
