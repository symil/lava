...
/// Wrapper for [VkSemaphoreSignalInfoKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkSemaphoreSignalInfoKHR.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkSemaphoreSignalInfo> for VkSemaphoreSignalInfo {
    fn vk_to_raw(src: &VkSemaphoreSignalInfo, dst: &mut RawVkSemaphoreSignalInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::SemaphoreSignalInfoKhr);
