...
/// Wrapper for [VkDeviceGeneratedCommandsFeaturesNVX](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkDeviceGeneratedCommandsFeaturesNVX.html).
#[derive(Debug, Clone)]
