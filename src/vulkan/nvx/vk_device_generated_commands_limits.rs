...
/// Wrapper for [VkDeviceGeneratedCommandsLimitsNVX](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkDeviceGeneratedCommandsLimitsNVX.html).
#[derive(Debug, Clone)]
