...
/// Wrapper for [VkAttachmentDescription2](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAttachmentDescription2.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkAttachmentDescription2> for VkAttachmentDescription2 {
    fn vk_to_raw(src: &VkAttachmentDescription2, dst: &mut RawVkAttachmentDescription2) {
        dst.s_type = vk_to_raw_value(&VkStructureType::AttachmentDescription2);
