...
/// Wrapper for [VkAttachmentReference2](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkAttachmentReference2.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkAttachmentReference2> for VkAttachmentReference2 {
    fn vk_to_raw(src: &VkAttachmentReference2, dst: &mut RawVkAttachmentReference2) {
        dst.s_type = vk_to_raw_value(&VkStructureType::AttachmentReference2);
