...
/// Wrapper for [VkBufferUsageFlags](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkBufferUsageFlags.html).
///
...
impl VkWrappedType<RawVkBufferUsageFlags> for VkBufferUsageFlags {
    fn vk_to_raw(src: &VkBufferUsageFlags, dst: &mut RawVkBufferUsageFlags) {
        *dst = 0;
        ...
        if src.ray_tracing_khr { *dst |= 0x00000400; }
    }
}
...
impl VkRawType<VkBufferUsageFlags> for RawVkBufferUsageFlags {
    fn vk_to_wrapped(src: &RawVkBufferUsageFlags) -> VkBufferUsageFlags {
        VkBufferUsageFlags {
            ...
            ray_tracing_khr: (src & 0x00000400) != 0,
        }
    }
}
...
impl VkBufferUsageFlags {
    ...
    pub fn to_u32(&self) -> u32 {
        ...
        + if self.ray_tracing_khr { 0x00000400 } else { 0 }
    }
    ...
    pub fn from_u32(value: u32) -> Self {
        VkBufferUsageFlags {
            ...
            ray_tracing_khr: value & 0x00000400 > 0,
        }
    }
}
