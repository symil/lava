...
/// Wrapper for [VkDescriptorSetVariableDescriptorCountAllocateInfo](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkDescriptorSetVariableDescriptorCountAllocateInfo.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkDescriptorSetVariableDescriptorCountAllocateInfo> for VkDescriptorSetVariableDescriptorCountAllocateInfo {
    fn vk_to_raw(src: &VkDescriptorSetVariableDescriptorCountAllocateInfo, dst: &mut RawVkDescriptorSetVariableDescriptorCountAllocateInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::DescriptorSetVariableDescriptorCountAllocateInfo);
