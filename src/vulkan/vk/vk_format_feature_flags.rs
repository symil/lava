...
/// Wrapper for [VkFormatFeatureFlags](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkFormatFeatureFlags.html).
///
...
pub struct VkFormatFeatureFlags {
    ...
    pub acceleration_structure_vertex_buffer_khr: bool,
...
impl VkWrappedType<RawVkFormatFeatureFlags> for VkFormatFeatureFlags {
    fn vk_to_raw(src: &VkFormatFeatureFlags, dst: &mut RawVkFormatFeatureFlags) {
        *dst = 0;
        ...
        if src.acceleration_structure_vertex_buffer_khr { *dst |= 0x20000000; }
...
impl VkRawType<VkFormatFeatureFlags> for RawVkFormatFeatureFlags {
    fn vk_to_wrapped(src: &RawVkFormatFeatureFlags) -> VkFormatFeatureFlags {
        VkFormatFeatureFlags {
            ...
            acceleration_structure_vertex_buffer_khr: (src & 0x20000000) != 0,
...
impl Default for VkFormatFeatureFlags {
    fn default() -> VkFormatFeatureFlags {
        VkFormatFeatureFlags {
            ...
            acceleration_structure_vertex_buffer_khr: false,
...
impl VkFormatFeatureFlags {
    ...
    pub fn all() -> Self {
        VkFormatFeatureFlags {
            ...
            acceleration_structure_vertex_buffer_khr: true,
    ...
    pub fn to_u32(&self) -> u32 {
        ...
        + if self.acceleration_structure_vertex_buffer_khr { 0x20000000 } else { 0 }
    ...
    pub fn from_u32(value: u32) -> Self {
        VkFormatFeatureFlags {
            ...
            acceleration_structure_vertex_buffer_khr: value & 0x20000000 > 0,
