...
/// Wrapper for [VkImageFormatListCreateInfo](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkImageFormatListCreateInfo.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkImageFormatListCreateInfo> for VkImageFormatListCreateInfo {
    fn vk_to_raw(src: &VkImageFormatListCreateInfo, dst: &mut RawVkImageFormatListCreateInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::ImageFormatListCreateInfo);
