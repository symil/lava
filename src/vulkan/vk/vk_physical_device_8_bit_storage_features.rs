...
/// Wrapper for [VkPhysicalDevice8BitStorageFeatures](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDevice8BitStorageFeatures.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDevice8BitStorageFeatures> for VkPhysicalDevice8BitStorageFeatures {
    fn vk_to_raw(src: &VkPhysicalDevice8BitStorageFeatures, dst: &mut RawVkPhysicalDevice8BitStorageFeatures) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDevice8bitStorageFeatures);
