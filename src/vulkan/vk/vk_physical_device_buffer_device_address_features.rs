...
/// Wrapper for [VkPhysicalDeviceBufferDeviceAddressFeatures](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkPhysicalDeviceBufferDeviceAddressFeatures.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDeviceBufferDeviceAddressFeatures> for VkPhysicalDeviceBufferDeviceAddressFeatures {
    fn vk_to_raw(src: &VkPhysicalDeviceBufferDeviceAddressFeatures, dst: &mut RawVkPhysicalDeviceBufferDeviceAddressFeatures) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDeviceBufferDeviceAddressFeatures);
