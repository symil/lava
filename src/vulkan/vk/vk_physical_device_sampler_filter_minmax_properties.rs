...
/// Wrapper for [VkPhysicalDeviceSamplerFilterMinmaxProperties](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkPhysicalDeviceSamplerFilterMinmaxProperties.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDeviceSamplerFilterMinmaxProperties> for VkPhysicalDeviceSamplerFilterMinmaxProperties {
    fn vk_to_raw(src: &VkPhysicalDeviceSamplerFilterMinmaxProperties, dst: &mut RawVkPhysicalDeviceSamplerFilterMinmaxProperties) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDeviceSamplerFilterMinmaxProperties);
