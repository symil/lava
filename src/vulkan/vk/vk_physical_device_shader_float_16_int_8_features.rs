...
/// Wrapper for [VkPhysicalDeviceShaderFloat16Int8Features](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkPhysicalDeviceShaderFloat16Int8Features.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDeviceShaderFloat16Int8Features> for VkPhysicalDeviceShaderFloat16Int8Features {
    fn vk_to_raw(src: &VkPhysicalDeviceShaderFloat16Int8Features, dst: &mut RawVkPhysicalDeviceShaderFloat16Int8Features) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDeviceShaderFloat16Int8Features);
