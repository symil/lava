...
/// Wrapper for [VkPhysicalDeviceVulkanMemoryModelFeatures](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkPhysicalDeviceVulkanMemoryModelFeatures.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkPhysicalDeviceVulkanMemoryModelFeatures> for VkPhysicalDeviceVulkanMemoryModelFeatures {
    fn vk_to_raw(src: &VkPhysicalDeviceVulkanMemoryModelFeatures, dst: &mut RawVkPhysicalDeviceVulkanMemoryModelFeatures) {
        dst.s_type = vk_to_raw_value(&VkStructureType::PhysicalDeviceVulkanMemoryModelFeatures);
