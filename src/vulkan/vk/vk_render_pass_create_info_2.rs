...
use vulkan::vk::{VkAttachmentDescription2,RawVkAttachmentDescription2};
use vulkan::vk::{VkSubpassDescription2,RawVkSubpassDescription2};
use vulkan::vk::{VkSubpassDependency2,RawVkSubpassDependency2};

/// Wrapper for [VkRenderPassCreateInfo2](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkRenderPassCreateInfo2.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkRenderPassCreateInfo2> for VkRenderPassCreateInfo2 {
    fn vk_to_raw(src: &VkRenderPassCreateInfo2, dst: &mut RawVkRenderPassCreateInfo2) {
        dst.s_type = vk_to_raw_value(&VkStructureType::RenderPassCreateInfo2);
