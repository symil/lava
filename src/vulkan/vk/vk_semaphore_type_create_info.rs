...
use vulkan::vk::{VkSemaphoreType,RawVkSemaphoreType};

/// Wrapper for [VkSemaphoreTypeCreateInfo](https://www.khronos.org/registry/vulkan/specs/1.2-extensions/man/html/VkSemaphoreTypeCreateInfo.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkSemaphoreTypeCreateInfo> for VkSemaphoreTypeCreateInfo {
    fn vk_to_raw(src: &VkSemaphoreTypeCreateInfo, dst: &mut RawVkSemaphoreTypeCreateInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::SemaphoreTypeCreateInfo);
