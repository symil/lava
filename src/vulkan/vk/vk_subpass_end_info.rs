...
/// Wrapper for [VkSubpassEndInfo](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkSubpassEndInfo.html).
#[derive(Debug, Clone)]
...
impl VkWrappedType<RawVkSubpassEndInfo> for VkSubpassEndInfo {
    fn vk_to_raw(src: &VkSubpassEndInfo, dst: &mut RawVkSubpassEndInfo) {
        dst.s_type = vk_to_raw_value(&VkStructureType::SubpassEndInfo);
